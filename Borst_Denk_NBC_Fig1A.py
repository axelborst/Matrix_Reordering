...
def show_variable_circuit(mixed,box_xpos,box_ypos):
    ...
    bs.setmyaxes(box_xpos,box_ypos,0.1,0.20)
...
def showcircuit(mixed,recurr,mytitle,box_ypos):
    ...
    bs.setmyaxes(0.38,box_ypos,0.1,0.20)
    ...
    bs.setmyaxes(0.1,box_ypos,0.22,0.19)
...
def show_alpha(box_xpos,box_ypos):
    ...
    bs.setmyaxes(box_xpos,box_ypos,box_xsiz,box_ysiz)
...
def plot_figure():
    ...
    if save_switch==1:
        ...
        plt.savefig('Borst_Denk_NBC_Fig1A.tiff',dpi=300)
