...
def plot_all(M1,M2,M3,z,nofswitches):
    ...
    bs.setmyaxes(0.1,boxypos,boxsize,boxsize)
    plotmatrix(M1,'original')
    bs.setmyaxes(0.4,boxypos,boxsize,boxsize)
    plotmatrix(M2,'scrambled')
    bs.setmyaxes(0.7,boxypos,boxsize,boxsize)
    plotmatrix(M3,'sorted')
    
    xsize=0.22
    ysize=0.15
    
    bs.setmyaxes(0.1,0.05,xsize,ysize)
    ...
    bs.setmyaxes(0.4,0.05,xsize,ysize)
    ...
    bs.setmyaxes(0.7,0.05,xsize,ysize)
...
def plot_figure():
    ...
    if save_switch==1:
        ...
        plt.savefig('Borst_Denk_NBC_Fig1BCDE.tiff',dpi=300)
