...
direct='SIPaper_Data/Stripe_Block/'
...
def one_run(mydim,switch):
    ...
    M_BD=sl.SI_sort(M_SC,mode='bandwidth',jac=jac)
...
def plot_Fig_4C(switch,myrange):
...
def plot_figure():
    ...
    plot_Fig_4C(switch='stripe',myrange='small')
    
    setmyaxes(.56,.38,.35,.23)
    plot_Fig_4C(switch='block',myrange='small')
